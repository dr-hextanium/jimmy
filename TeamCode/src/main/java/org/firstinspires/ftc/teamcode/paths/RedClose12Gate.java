...
public class RedClose12Gate {
    ...
    public RedClose12Gate(Follower follower) {
        ...
        HitGate = follower.pathBuilder().addPath(
                        new BezierCurve(
                                ...
                                new Pose(22.500, 78.500),
                                new Pose(130.0, 72.000)
                        )
        ...
        Leave = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(shotAngle - 2), Math.toRadians(0))
