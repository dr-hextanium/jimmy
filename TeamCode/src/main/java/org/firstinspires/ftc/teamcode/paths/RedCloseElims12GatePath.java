...
public class RedCloseElims12GatePath {
    ...
    public RedCloseElims12GatePath(Follower follower) {
        ...
        ScoreSpike3Part2 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(-55), Math.toRadians(36))
