...
public class BlueClose12PathsOld {
    ...
    double blueShootingAngle = 129.0 + 8.0;

    public BlueClose12PathsOld(Follower follower) {
        ...
        ScoreSpike1 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(blueShootingAngle))
        ...
        AlignSpike2 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(blueShootingAngle), Math.toRadians(180))
        ...
        PrepAlignSpike3 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(blueShootingAngle), Math.toRadians(270))
                .build();
        ...
        ScoreSpike3Part2 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(235), Math.toRadians(blueShootingAngle))
